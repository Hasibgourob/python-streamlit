...
# Custom CSS for dark sidebar with white text and visible title
st.markdown(
    """
    <style>
...
def main():
    ...
    st.markdown("<h1 style='text-align: left; margin-top: 0; padding-top: 0;'>📊 A/B টেস্টিং রিপোর্ট</h1>", 
               unsafe_allow_html=True)
    ...
    if error:
        ...
        st.snow()  # Add snowfall effect here if you prefer
    ...
    if st.button("ডেটা রিফ্রেশ করুন"):
        ...
        with st.spinner('ডেটা রিফ্রেশ হচ্ছে...'):
            for i in range(100):
        ...
        st.success("ডেটা রিফ্রেশ করা হয়েছে!")  # Show success message after refreshing
    ...
    if auto_refresh:
        ...
        with st.spinner('ডেটা আপডেট হচ্ছে...'):
            for i in range(100):
                time.sleep(0.05)  # Simulate the refreshing process
                progress_bar.progress(i + 1)  # Update progress
        st.success("ডেটা আপডেট হয়ে গেছে!")  # Show success message after auto-refresh
